          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                ...
                premium quality products that elevate their everyday experience.
                What began as a small passion project has grown into a brand
                trusted by thousands worldwide.
              </p>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Every product in our collection is carefully curated to meet our
                exacting standards for quality, design, and sustainability. We
                partner with skilled craftspeople and ethical manufacturers who
                share our vision.
              </p>
              <Button
                asChild
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              We believe that exceptional products have the power to transform
              ordinary moments into extraordinary ones. Our mission is to curate
              and deliver premium quality goods that inspire confidence, spark
